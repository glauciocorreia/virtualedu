      ...
      <div id="accordion" class="listaElementos">
          ...
          <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
            <div class="card-body">
              <div class="col-12 d-flex">
                ...
                <div class="col-3">
                  <button type="button" name="editProfessor" id="editProfessor" class="btn btn-info btn-xs btn-block">Editar</button>
                  <button type="button" name="deleteProfessor" id="deleteProfessor" class="btn btn-danger btn-xs btn-block">Excluir</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="card">
          <div class="card-header" id="headingTwo" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true"
            ...
            <h5 class="mb-0">
              Jaguaribe Grugiere de Lourdina
            </h5>
          </div>
        ...
        <div class="card">
          <div class="card-header" id="headingThree" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true"
            ...
            <h5 class="mb-0">
              Maracapanita de Jurubeba Petrônio
            </h5>
          </div>
